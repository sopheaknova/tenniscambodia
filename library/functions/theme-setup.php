...
if( !function_exists('sp_theme_setup') )
{
	function sp_theme_setup(){
		...
		add_image_size('post-slider', 640, 366, true ); // base size 1240x768
		add_image_size('thumb-medium', 200, 124, true ); // base size 1240x768
...
function sp_custom_login_logo() {
    echo '<style type="text/css">
        ...
        .login h1 a { background-image:url('.ot_get_option('custom-logo').') !important; width:auto; height:100px; background-size: auto auto !important;}
    </style>';
}
